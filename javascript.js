...
function getHumanChoice(){
 ...
 if (humanChoice.toLocaleLowerCase()!=='rock' && humanChoice.toLowerCase()!== 'paper' && humanChoice.toLocaleLowerCase()!== 'scissors'){
  alert("WRONG INPUT!")
 }
...
function playRound (humanChoice,computerChoice){
 if (humanChoice === "rock" && computerChoice === "rock") {
   ...
   alert("Player choose Rock and Computer choose Paper therefor Computer wins");
   computerScore++;
   getScore();
   return;
